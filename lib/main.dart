    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.light(
            primaryContainer: const Color(0xFFFFFFFF), // Card background
            onPrimary: const Color(0xFF2A1E39), // Section titles and large text color
            onPrimaryFixed: const Color(0xFF736B7C), // Small text on cards
            onPrimaryFixedVariant: const Color(0xFFA448FF), // Other small text on cards
            secondaryContainer: const Color(0xFF420085),
            secondary: const Color(0xFFFFFFFF),
            tertiaryContainer: const Color(0xFFA9EACE), // Dial Background
            tertiary: const Color(0xFF48A388), // Dial Foreground
